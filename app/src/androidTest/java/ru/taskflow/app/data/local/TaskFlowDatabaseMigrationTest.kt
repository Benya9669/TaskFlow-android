...
class TaskFlowDatabaseMigrationTest {
    ...
    @Test fun migratesV1ToV2WithoutDeletingTasksOrOutbox() {
        ...
        val database = Room.databaseBuilder(InstrumentationRegistry.getInstrumentation().targetContext, TaskFlowDatabase::class.java, DB_NAME).addMigrations(TaskFlowDatabase.migration1To2).build()
